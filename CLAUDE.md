...
4. **v2 修訂時保留 v1 章節編號穩定**，新內容以子章節 / 增補表 / 重寫段形式無縫嵌入；任何 v2 新增 / 重寫 / 升級的段落明確標註「（v2 新增 / v2 重寫 / v2 升級）」便於追溯
...
- **v2 修訂保留章節編號穩定**：新內容以子章節 / 增補表 / 重寫段形式無縫嵌入；明確標註「（v2 新增 / v2 重寫 / v2 升級）」便於追溯
