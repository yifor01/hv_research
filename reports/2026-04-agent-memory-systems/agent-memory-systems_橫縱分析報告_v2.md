...
<svg viewBox="0 0 580 270" xmlns="http://www.w3.org/2000/svg">
  <text x="290" y="20" text-anchor="middle" font-size="11pt" font-weight="700" fill="#1a3d7c">v2 選型決策樹：兩層 gate + 四條主路徑</text>
  ...
  <text x="290" y="254" text-anchor="middle" font-size="8pt" fill="#999" font-style="italic">v2：對 self-host 企業，Long Context 路線實質不可用，memory 框架仍是主體。</text>
</svg>
