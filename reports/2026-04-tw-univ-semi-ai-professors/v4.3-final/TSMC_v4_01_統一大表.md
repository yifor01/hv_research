...
| B47 | 李宏毅 | NTU EE 正教授（2023 升等；PhD: NTU 通訊所 2012）| 語音 / NLP / 自監督學習 / LALM | h-62 / 引用 17,964；SUPERB benchmark（1,312 引）；Can LLMs Replace Human Evaluators（1,092 引）；YouTube 教學頻道 400+ 萬觀看；MIT CSAIL 訪問 2013-2014 | 無公開可見業界綁定（已確認非 Appier 共同創辦人）| 半導體論文零；方法論需橋接 | 工程師效率：LALM hands-free 操作 / 交班轉寫 / LLM-as-Evaluator 文件審查；Self-Sup 方法論可橋接設備聲學異常 | Speech Processing and ML Lab | 不啟動（保留橋接）| 無 | 工程師效率軸候補（非主軸）：先做 LLM-as-Evaluator SOP/ECN/FMEA 審查 PoC（3-6 月，最低橋接成本）；視成果再評估 hands-free LALM / 自監督聲學異常 | 6.1 分；半導體無直接交集，定位為跨域方法論候補；YouTube 影響力 = AI 人才漏斗 |
...
| B53 | 陳正剛（Argon Chen）| NTU 工工 教授（PhD: Rutgers IE）| SPC (2009 前) / 超音波/OSA (2009 後) / 工程資料探勘 | h-22 / 引用 1,813 / i10-41；Optimal levels of process parameters（258 引，1993）；台大醫院甲狀腺超音波 CAD 合作；自 2009 轉生醫 | Jakey Blue 之師 | 歷史方法論顧問 | SPC/APC 方法論歷史權威；Jakey Blue（B45）之師，可作 Tier 2 方法論會診 | NTU 工工 Lab 3 人 | 不啟動（Tier 2 顧問）| 無 | Tier 2 顧問：依 Jakey Blue 案需求橋接 SPC/APC 方法論會診；不獨立委案 PI | 4.5 分；2009 後轉生醫，半導體 SPC 代表作 10+ 年 |
| B54 | 謝旻甫 | NCKU 電機 特聘教授（since 2022）+ 電機馬達技術中心（PhD: U Liverpool 機械 2000）| 馬達驅動 AI / 廠務風機預測維護 | h-36 / 引用 4,240；**2025 IET Fellow**；IEEE Magnetics Society Distinguished Lecturer 2025-2026；Stanford Top 2% Scientists 2022-2024；2022 李國鼎金質獎；2024 國科會傑出研究獎；前 NCKU 研發副校長 2023-2025 | 台達電 Chair 2019-2024；中鋼/國太中心合作 | 廠務應用 | 廠務風機 / 馬達驅動預測維護（fab 設施軸，非製程軸）| 電機與驅動系統實驗室 約 30 人 | 不啟動（轉介設施軸）| 台達電 Chair 2019-2024 | 轉介 Fab 設施部門：廠務風機 / 馬達驅動預測維護專案；本盤點（製程 AI 軸）不啟動 | 4.4 分；廠務軸而非製程 AI 軸 |
| B55 | 洪英超 | NTU 工工 教授（2022/8 從 NCCU 統計轉入；前 NCCU 統計系主任；PhD: U Michigan 統計 1995）| SVR Profile Monitoring / EV/Granger / 統計機器學習 | 42 篇論文 / 引用 370（ResearchGate）；2024 Granger 因果統計頂刊；2025 IEEE T-ITS EV 充電；曾訪 U Florida / MSR / 日本統計數理研究所 | 無綁定 | 方法論已漂移 | Granger Causality 因果統計可橋接 fab 多變量 SPC 根因分析（需方法論 PoC）| NTU IE Ying-Chao Hung Lab | 不啟動（單次諮詢）| 無 | 單次諮詢顧問：SPC 多變量因果鏈方法論問題；研究主軸已轉 EV 充電，不主動委案 PI | 4.2 分；統計頂刊 Granger 仍有橋接價值 |
| C56 | 林清安 | NTUST 機械 | 機械視覺 / 機械手臂 | 論文透明度低；曾列未入選 | 無 | 方向偏；證據不足 | 機械視覺 / 機械手臂與 fab AMHS / 後段封裝視覺定位有間接接點，但近年論文證據不足 | — | 不啟動（候補位）| 無 | 不主動接觸：證據不足；候補位待 AMHS / 封裝視覺軸 S/A 級 PI 飽和或缺人時再重評 | 4.0 分 |
| C57 | 柏林 Berlin Chen | NTNU 資工 | Mandarin ASR / BERT reranking | ASR 專家而非 LLM；半導體需 6-12 月橋接 | 無 | ASR 專項 | 台灣普通話 ASR → 製程文件檢索 / 工程師語音指令 | NTNU 資工 Lab | 不啟動（候補位）| 無 | ASR 專項 PoC（非主線）：與 B47 李宏毅工程師效率題目競合，李宏毅 LALM 路徑優先；候補位待主路徑卡關再考慮 | 3.8 分 |
| C58 | 王振興 | NCKU EE | Neuro-fuzzy / AIoT / 生醫 | 半導體契合僅 5%；主軸生醫訊號 | 無 | AIoT 邊緣 | AIoT / Neuro-fuzzy 邊緣推論方法論；fab 直接接點低（生醫主軸）| NCKU EE Lab | 不啟動（另案軸）| 無 | 不主動接觸：fab 製程契合度低；若 TSMC 員工穿戴監測 / 邊緣 AIoT 專案另起需求再評估 | 3.0 分 |
...
| C60 | 鄭少為 | NTHU 統計 副教授 | Gaussian Process / DoE | 近 5 年無頂期刊；副教授 17 年未升等 | 無 | 理論配套 | Gaussian Process / DoE 高維實驗設計（fab DoE 加速） | 無獨立 Lab | 不啟動（理論配套）| 無 | 理論配套（非獨立 PI）：可作他人主軸 PoC 的高維 DoE / GP 統計支援，不獨立委案；近 5 年產出薄弱 | 2.9 分 |
| C61 | 李祈均 | NTHU EE | Multimodal DL / Speech Affective | 0% 半導體；雙企業 COI 需先簽約 | NVIDIA 副主任 + 京元電子顧問 | 情感語音 | Multimodal 情感語音 → 工程師壓力 / 疲勞偵測（員工關懷軸，非製程）| BIIC Lab 12-18 人 | 不啟動（COI + 員工關懷軸）| NVIDIA 副主任 + 京元電子顧問 | COI 雙綁定先簽資訊牆協議；fab 應用接點僅員工狀態偵測（員工關懷軸非製程軸），優先度低 | 2.6 分 |
